 ...
 */
final class Version20250711070047 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE session CHANGE formateur_id formateur_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE session CHANGE formateur_id formateur_id INT NOT NULL');
